...
<p align="center">
  <a href="./docs/assets/screenshots/showcase-v2/landing-en-9f3a8fa0.webp"><img src="./docs/assets/screenshots/showcase-v2/landing-en-9f3a8fa0.webp" alt="TecPey English landing experience" width="100%" /></a>
</p>
...
## The product, in real browser captures

These are real TecPey product surfaces captured by the governed Public Browser Golden Path—not mockups or generated marketing UI. The README uses high-resolution 1440px derivatives so interface typography and product detail remain inspectable on GitHub. Provenance, source hashes and transformation rules are recorded in [`PROVENANCE.md`](./docs/assets/screenshots/showcase-v2/PROVENANCE.md).

### Academy — knowledge that becomes measurable progress

<p align="center">
  <a href="./docs/assets/screenshots/showcase-v2/academy-fa-9f3a8fa0.webp"><img src="./docs/assets/screenshots/showcase-v2/academy-fa-9f3a8fa0.webp" alt="TecPey Academy Persian product surface" width="100%" /></a>
</p>
...
<p align="center">
  <a href="./docs/assets/screenshots/showcase-v2/arena-fa-9f3a8fa0.webp"><img src="./docs/assets/screenshots/showcase-v2/arena-fa-9f3a8fa0.webp" alt="TecPey Trading Arena with virtual capital" width="100%" /></a>
</p>
...
<p align="center">
  <a href="./docs/assets/screenshots/showcase-v2/mentor-fa-9f3a8fa0.webp"><img src="./docs/assets/screenshots/showcase-v2/mentor-fa-9f3a8fa0.webp" alt="TecPey personalized AI Mentor product surface" width="100%" /></a>
</p>
...
- [Showcase v2 provenance](./docs/assets/screenshots/showcase-v2/PROVENANCE.md)
