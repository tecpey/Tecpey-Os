...
**Since that audit**, controlled-launch hardening has continued to merge into `main`. Issues **#162** (repository-wide lint/correctness authority) and **#164** (fail-closed CSP connection allowlist) are now **closed**, and issues #77, #156, and #254 have also closed. Subsequent security work added a read-only Exchange ledger reconciliation authority (#285), a tenant-scoped table coverage gate with a 27-table registry (#286), and the first two tables promoted to proven cross-tenant isolation (#287), alongside repaired and new structural governance gates (#284). The launch-evidence batch through PRs **#331–#336** added governed recovery reconciliation, staging-readiness evidence, deterministic CRM CI coverage, a controlled-launch evidence digest, the controlled Go/No-Go checklist, and accepted-risk reconciliation.
