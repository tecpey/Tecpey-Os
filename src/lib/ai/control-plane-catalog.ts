...
export const AI_AGENT_CATALOG: readonly AiAgentCatalogItem[] = Object.freeze([
  ...
  {
    id: "growth_hacker",
    labelFa: "Growth Hacker ارگانیک تک‌پی",
    labelEn: "TecPey Organic Growth Hacker",
    responsibilityFa:
      "کشف فرصت‌های رشد ارگانیک از Search، X، وب، خبر، کوین و ابزار؛ ساخت پیشنهاد SEO/AEO/GEO منبع‌دار و قابل اندازه‌گیری بدون keyword stuffing یا انتشار مستقیم.",
    responsibilityEn:
      "Discover organic growth opportunities across Search, X, web, news, coins and tools; produce cited SEO/AEO/GEO recommendations without keyword stuffing or direct publishing.",
    allowedProviders: ["xai", "perplexity", "openai", "openrouter"],
    allowedTools: ["x_search", "web_search", "aggregate_metrics"],
    readableScopes: [
      "public.x.read",
      "public.web.read",
      "catalog.coins.read",
      "catalog.tools.read",
      "growth.trends.read",
      "growth.search_analytics.aggregate.read",
      "operations.evidence.summary.read",
    ],
    forbiddenActions: [
      "private_user_data",
      "keyword_stuffing",
      "doorway_page_generation",
      "search_engine_cloaking",
      "fake_citation",
      "external_publish",
      "financial_execution",
      "buy_sell_signal",
...
export const AI_WORKFLOW_CATALOG = Object.freeze([
  ...
  {
    id: "organic_growth_acceleration",
    labelFa: "موتور رشد ارگانیک SEO/GEO/AEO",
    labelEn: "SEO/GEO/AEO organic growth engine",
    stages: [
      "growth_hacker",
      "news_x_researcher",
      "coin_tool_researcher",
