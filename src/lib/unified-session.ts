...
/**
 * Issue a replacement cookie only after its JTI is durably registered. This is
 * required for profile claim changes and any future server-owned claim refresh.
 */
