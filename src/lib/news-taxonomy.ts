...
const TOPICS: readonly NewsTopicTag[] = [
  ...
  { id: "security", labelFa: "امنیت", labelEn: "Security", aliases: ["hack", "exploit", "phishing", "breach", "data breach", "data breaches", "data leak", "data leaks", "cyberattack", "cyber attack", "ransomware", "extortion", "malware", "drainer", "rug pull", "scam", "هک", "فیشینگ", "اسکم", "کلاهبرداری", "امنیت", "نشت داده", "نشت اطلاعات", "افشای داده", "افشای اطلاعات", "داده های مشتریان", "اطلاعات مشتریان", "حمله سایبری", "باج افزار", "باج‌افزار"], searchIntents: ["crypto hack news", "اخبار هک ارز دیجیتال"] },
