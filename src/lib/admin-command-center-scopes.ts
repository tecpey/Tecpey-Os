...
// CAN be scoped are scoped. Two still cannot: academy_students and
// mentor_challenge_attempts have no tenant column at all, and academy_students
// is the academy root with 43 tables pointing at it, so giving it a tenant
// boundary is its own program. (academy_certificates gained one in migration
// 0070 and notification_center in 0071; both moved to "tenant".)
//
...
export const COMMAND_CENTER_METRICS = Object.freeze({
  ...
  notifications: Object.freeze({ table: "notification_center", scope: "tenant" }),
