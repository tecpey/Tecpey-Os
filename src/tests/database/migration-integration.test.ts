...
const REQUIRED_COLUMNS = [
  ...
  ["mentor_profile_update_outbox", "tenant_id"],
  ["mentor_profile_update_outbox", "workspace_id"],
  ["mentor_profile_update_outbox", "payload_hash"],
  ["mentor_profile_update_outbox", "lease_expires_at"],
  ["mentor_profile_update_outbox", "profile_result_hash"],
  ["mentor_profile_update_attempts", "tenant_id"],
  ["mentor_profile_update_attempts", "workspace_id"],
  ["mentor_profile_update_dead_letters", "tenant_id"],
  ["mentor_profile_update_dead_letters", "workspace_id"],
  ["mentor_profile_update_dead_letters", "student_fingerprint"],
...
const REQUIRED_INDEXES = [
  ...
  "mentor_profile_update_outbox_claim_idx",
  "mentor_profile_update_outbox_lease_idx",
  "mentor_profile_update_attempts_outbox_idx",
  "mentor_profile_update_outbox_terminal_idx",
