...
export const metadata: Metadata = {
  ...
  description: "نمای کلی وضعیت سرویس‌های اصلی تک‌پی برای اعتماد و شفافیت بیشتر.",
  alternates: { canonical: "https://tecpey.ir/status" },
};

const cards = [
  { title: "وب‌سایت", desc: "صفحات اطلاع‌رسانی، آکادمی، بازار و مرکز دانش تک‌پی." },
  { title: "پشتیبانی", desc: "مسیرهای ارتباطی رسمی برای پاسخ‌گویی کاربران." },
  { title: "اطلاعیه‌ها", desc: "اطلاعیه‌های سرویس، وضعیت دسترسی و تغییرات مهم از همین بخش منتشر می‌شود." }
];

export default function Page() {
  return (
    <ContentShell>
      <ContentHero eyebrow="TecPey" title="وضعیت سرویس‌های تک‌پی" description="نمای کلی وضعیت سرویس‌های اصلی تک‌پی برای اعتماد و شفافیت بیشتر." ctaHref="/contact-us" ctaLabel="ارتباط با تک‌پی" />
      <section className="px-4 py-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="rounded-[34px] border border-cyan-400/20 bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,.16),transparent_34%),linear-gradient(145deg,#07111f,#0f172a)] p-6 text-white shadow-2xl shadow-cyan-500/10 md:p-8">
            ...
            <p className="mt-4 max-w-4xl text-base leading-9 text-white/72">در این بخش وضعیت سرویس‌های اصلی، بازارها، پشتیبانی و مسیرهای ارتباطی تک‌پی به‌صورت شفاف نمایش داده می‌شود.</p>
          </div>
