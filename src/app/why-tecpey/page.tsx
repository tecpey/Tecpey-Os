...
const cards = [
  { title: "شروع ساده", desc: "ثبت‌نام، مشاهده بازار و ورود به معامله باید روشن، سریع و بدون پیچیدگی غیرضروری باشد." },
  { title: "شفافیت قبل از معامله", desc: "پیش از تصمیم‌گیری، قیمت، مسیر و کارمزدها به‌صورت روشن نمایش داده می‌شود." },
  { title: "محتوای آموزشی", desc: "تک‌پی فقط محل معامله نیست؛ مسیر یادگیری و تصمیم آگاهانه هم هست." }
];

export default function Page() {
  return (
    <ContentShell>
      <ContentHero eyebrow="TecPey" title="چرا تک‌پی؟" description="دلایلی که تک‌پی را به یک مسیر قابل اعتماد برای شروع معامله رمزارز تبدیل می‌کند." ctaHref="/contact-us" ctaLabel="ارتباط با تک‌پی" />
      <section className="px-4 py-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="rounded-[34px] border border-cyan-400/20 bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,.16),transparent_34%),linear-gradient(145deg,#07111f,#0f172a)] p-6 text-white shadow-2xl shadow-cyan-500/10 md:p-8">
            ...
            <p className="mt-4 max-w-4xl text-base leading-9 text-white/72">اعتماد، شفافیت، تجربه موبایل‌فرست، آموزش و پشتیبانی فارسی، ستون‌های اصلی تک‌پی هستند.</p>
          </div>
