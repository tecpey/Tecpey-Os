...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://tecpey.ir/en/academy/simulator" },
};

export default function EnglishTradingSimulatorPage() {
  return <EnglishShell><AcademySimulationWorld locale="en" focus="trading" /></EnglishShell>;
}
