...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://tecpey.ir/en/academy/portfolio-lab" },
};

export default function EnglishPortfolioLabPage() {
  return <EnglishShell><AcademySimulationWorld locale="en" focus="portfolio" /></EnglishShell>;
}
