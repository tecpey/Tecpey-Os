...
export default function EnglishMarketsPageClient({
  ...
  // view (empty query) — see src/app/en/markets/page.tsx. It only applies
  // to the query's very first observation of this key.
  const { data, isFetching } = useQuery({
    ...
    initialData: query.trim() === "" ? initialCurrencies : undefined,
  });
