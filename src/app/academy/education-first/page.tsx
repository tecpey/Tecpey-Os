...
export const metadata: Metadata = { title: "Education-first | آکادمی تک‌پی", description: "در تک‌پی آموزش قبل از دعوت به معامله قرار می‌گیرد؛ چون اعتماد پایدار با آگاهی ساخته می‌شود، نه با فشار برای ثبت‌نام سریع." };

const items = ["اول فهم مفاهیم پایه", "بعد سنجش آمادگی", "بعد ابزار و تمرین", "در نهایت تصمیم آگاهانه"];
    ...
    <ContentShell>
      <main className="bg-[color:var(--tp-bg)] px-4 py-24 sm:px-6 lg:px-8">
        <section className="mx-auto max-w-5xl rounded-[34px] border border-cyan-300/15 bg-white/[0.07] p-6 shadow-2xl shadow-cyan-500/10 backdrop-blur-xl lg:p-10">
          ...
          <h1 className="mt-5 text-3xl font-black leading-tight text-white sm:text-5xl">Education-first</h1>
          <p className="mt-5 text-base font-bold leading-9 text-slate-300">در تک‌پی آموزش قبل از دعوت به معامله قرار می‌گیرد؛ چون اعتماد پایدار با آگاهی ساخته می‌شود، نه با فشار برای ثبت‌نام سریع.</p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/academy/signup" className="inline-flex items-center gap-2 rounded-2xl bg-cyan-500 px-5 py-3 text-sm font-black text-white transition hover:bg-cyan-400">
              ادامه مسیر
