...
export const metadata: Metadata = { title: "Risk-aware | آکادمی تک‌پی", description: "تجربه تک‌پی باید مدام به کاربر یادآوری کند که بازار رمزارز بدون مدیریت ریسک می‌تواند خطرناک باشد." };

const items = ["حد ضرر و سرمایه قابل تحمل", "کارمزد معامله و شبکه", "ریسک نقدشوندگی و نوسان", "پرهیز از خرید هیجانی"];
    ...
    <ContentShell>
      <main className="bg-[color:var(--tp-bg)] px-4 py-24 sm:px-6 lg:px-8">
        <section className="mx-auto max-w-5xl rounded-[34px] border border-cyan-300/15 bg-white/[0.07] p-6 shadow-2xl shadow-cyan-500/10 backdrop-blur-xl lg:p-10">
          ...
          <h1 className="mt-5 text-3xl font-black leading-tight text-white sm:text-5xl">Risk-aware</h1>
          <p className="mt-5 text-base font-bold leading-9 text-slate-300">تجربه تک‌پی باید مدام به کاربر یادآوری کند که بازار رمزارز بدون مدیریت ریسک می‌تواند خطرناک باشد.</p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/academy/decision" className="inline-flex items-center gap-2 rounded-2xl bg-cyan-500 px-5 py-3 text-sm font-black text-white transition hover:bg-cyan-400">
              ادامه مسیر
