...
export const metadata: Metadata = { title: "Tool-based decisions | آکادمی تک‌پی", description: "تصمیم حرفه‌ای با ابزار و چک‌لیست ساخته می‌شود؛ نه با حدس، ترس، طمع یا توصیه‌های بی‌منبع." };

const items = ["ماشین‌حساب ریسک", "ژورنال معاملاتی", "چک‌لیست قبل از خرید", "سناریوی ورود و خروج"];
    ...
    <ContentShell>
      <main className="bg-[color:var(--tp-bg)] px-4 py-24 sm:px-6 lg:px-8">
        <section className="mx-auto max-w-5xl rounded-[34px] border border-cyan-300/15 bg-white/[0.07] p-6 shadow-2xl shadow-cyan-500/10 backdrop-blur-xl lg:p-10">
          ...
          <h1 className="mt-5 text-3xl font-black leading-tight text-white sm:text-5xl">Tool-based decisions</h1>
          <p className="mt-5 text-base font-bold leading-9 text-slate-300">تصمیم حرفه‌ای با ابزار و چک‌لیست ساخته می‌شود؛ نه با حدس، ترس، طمع یا توصیه‌های بی‌منبع.</p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/academy/tools" className="inline-flex items-center gap-2 rounded-2xl bg-cyan-500 px-5 py-3 text-sm font-black text-white transition hover:bg-cyan-400">
              ادامه مسیر
