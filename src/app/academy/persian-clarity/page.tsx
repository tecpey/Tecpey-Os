...
export const metadata: Metadata = { title: "Persian clarity | آکادمی تک‌پی", description: "مزیت تک‌پی این است که مفاهیم پیچیده بازار را با فارسی روشن، قابل فهم و بدون ترساندن کاربر توضیح دهد." };

const items = ["زبان ساده و انسانی", "مثال واقعی برای کاربر ایرانی", "پرهیز از اصطلاحات نمایشی", "تمرکز بر رفتار امن و کاربردی"];
    ...
    <ContentShell>
      <main className="bg-[color:var(--tp-bg)] px-4 py-24 sm:px-6 lg:px-8">
        <section className="mx-auto max-w-5xl rounded-[34px] border border-cyan-300/15 bg-white/[0.07] p-6 shadow-2xl shadow-cyan-500/10 backdrop-blur-xl lg:p-10">
          ...
          <h1 className="mt-5 text-3xl font-black leading-tight text-white sm:text-5xl">Persian clarity</h1>
          <p className="mt-5 text-base font-bold leading-9 text-slate-300">مزیت تک‌پی این است که مفاهیم پیچیده بازار را با فارسی روشن، قابل فهم و بدون ترساندن کاربر توضیح دهد.</p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/academy" className="inline-flex items-center gap-2 rounded-2xl bg-cyan-500 px-5 py-3 text-sm font-black text-white transition hover:bg-cyan-400">
              ادامه مسیر
