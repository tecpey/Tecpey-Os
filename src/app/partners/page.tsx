...
export const metadata: Metadata = {
  title: "همکاری با تک‌پی | تک‌پی",
  description: "مسیر همکاری برندها، کسب‌وکارها و فعالان بازار با تک‌پی.",
  alternates: { canonical: "https://tecpey.ir/partners" },
};

const cards = [
  { title: "همکاری محتوایی", desc: "تولید محتوای آموزشی و کمپین‌های آگاهی‌بخش برای کاربران رمزارز." },
  { title: "همکاری تجاری", desc: "تعریف مسیرهای همکاری برای کسب‌وکارها، فروشگاه‌ها و برندهای فین‌تک." },
  { title: "همکاری رسانه‌ای", desc: "پوشش خبری، معرفی خدمات و توسعه اعتبار برند تک‌پی." }
];

export default function Page() {
  return (
    <ContentShell>
      <ContentHero eyebrow="TecPey" title="همکاری با تک‌پی" description="مسیر همکاری برندها، کسب‌وکارها و فعالان بازار با تک‌پی." ctaHref="/contact-us" ctaLabel="ارتباط با تک‌پی" />
      <section className="px-4 py-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="rounded-[34px] border border-cyan-400/20 bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,.16),transparent_34%),linear-gradient(145deg,#07111f,#0f172a)] p-6 text-white shadow-2xl shadow-cyan-500/10 md:p-8">
            ...
            <p className="mt-4 max-w-4xl text-base leading-9 text-white/72">تک‌پی آماده همکاری‌های حرفه‌ای در حوزه آموزش، محتوا، پذیرش رمزارز و توسعه اکوسیستم فین‌تک است.</p>
          </div>
