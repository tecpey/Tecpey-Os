...
export const metadata: Metadata = {
  ...
  description: "پشتیبانی فارسی برای پاسخ به سوالات ثبت‌نام، بازار، کارمزد و شروع معامله.",
  alternates: { canonical: "https://tecpey.ir/support" },
};

const cards = [
  { title: "راه‌های تماس", desc: "تلفن، همراه، ایمیل، تلگرام، اینستاگرام و دیسکورد تک‌پی در دسترس هستند." },
  { title: "سوالات پرتکرار", desc: "بسیاری از پاسخ‌ها در FAQ و آکادمی تک‌پی آماده شده‌اند." },
  { title: "پیگیری مسئولانه", desc: "در مسائل مالی، پاسخ‌گویی باید دقیق، شفاف و قابل پیگیری باشد." }
];

export default function Page() {
  return (
    <ContentShell>
      <ContentHero eyebrow="TecPey" title="مرکز پشتیبانی تک‌پی" description="پشتیبانی فارسی برای پاسخ به سوالات ثبت‌نام، بازار، کارمزد و شروع معامله." ctaHref="/contact-us" ctaLabel="ارتباط با تک‌پی" />
      <section className="px-4 py-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="rounded-[34px] border border-cyan-400/20 bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,.16),transparent_34%),linear-gradient(145deg,#07111f,#0f172a)] p-6 text-white shadow-2xl shadow-cyan-500/10 md:p-8">
            ...
            <p className="mt-4 max-w-4xl text-base leading-9 text-white/72">تک‌پی باید در لحظه‌های مهم کنار کاربر باشد؛ از اولین سوال تا شروع معامله.</p>
          </div>
