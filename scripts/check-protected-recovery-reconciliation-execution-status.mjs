...
const REMAINING_OPEN_BLOCKERS = ["NOG-07", "NOG-08", "NOG-09"];
...
for (const invariant of [
  ...
  STATUS_PATH,
  "NOG-07, NOG-08 and NOG-09 remain open",
]) {
...
console.log(
  `Protected recovery reconciliation execution status passed for ${candidate.currentCandidate.sha}; NOG-05 is accepted and controlled launch remains NO-GO on NOG-07/NOG-08/NOG-09.`,
);
