...
const DOMAIN_RULES = [
  ...
  },
  {
    ...
    reviewBatch: 10,
    patterns: [
      /^src\/lib\/(?:coin-growth-automation|coin-visual-assets|content-growth|growth-analytics-contract|growth-trend-authority|growth-trend-intelligence|indexnow|landing-growth|landing-growth-authority|landing-story-data|news-article-evidence|news-automation|news-detail-pages|news-detail-body-authority|news-feed-evidence|news-full-evidence-capture|news-growth-authority|news-publisher-evidence|news-impact-history|news-impact-history-authority|news-intelligence-graph|news-materialization|news-provider-readiness|news-published-at|news-source-registry|news-taxonomy|news-translation|organic-growth-automation|public-market-data|tool-growth-automation|trading-tools-growth)\.ts$/,
    ],
  },
  {
    ...
    patterns: [
      ...
      /^src\/lib\/ops\//,
      /^src\/lib\/(?:alerts|bounded-http-body|degraded-read|env-placeholders|error-tracking|event-bus|logger|metrics|observe|socket|trace)\.ts$/,
