...
const REVIEWED_BASELINE_KEYS = new Set([
  ...
  "react-hooks/set-state-in-effect:src/components/academy/TradingArenaProClient.tsx:143:5",
  ...
  "react-hooks/set-state-in-effect:src/components/academy/trading-arena/JournalView.tsx:588:10",
  "react-hooks/set-state-in-effect:src/components/academy/trading-arena/JournalView.tsx:597:5",
  ...
  "react-hooks/set-state-in-effect:src/components/academy/trading-arena/TradingArenaExecutionClient.tsx:752:10",
  "react-hooks/set-state-in-effect:src/components/academy/v2/FlashcardDeck.tsx:245:5",
  ...
  "react-hooks/set-state-in-effect:src/components/admin/AdminPasskeyAccessGate.tsx:63:26",
