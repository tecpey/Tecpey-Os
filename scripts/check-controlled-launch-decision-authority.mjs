...
const ACTIVE_CANDIDATE_SHA = "8db71529b3b9250bab2462c5c151d00c3aef2754";
...
if (activeCandidate?.decision === ACTIVE_NO_GO_DECISION) {
  ...
  requireEqualValue("active candidate source PR", activeCandidate.currentCandidate?.sourcePullRequest, 685);
