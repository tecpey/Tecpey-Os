...
test("policy assigns explicit provenance, domains, batches and pending status", () => {
  ...
  assert.deepEqual(classifyDomain("config/secret-scanning-baseline.json"), {
    domain: "authentication-admin-security",
    riskTier: "P1",
    reviewBatch: 3,
    classificationRule: "authentication-admin-security",
  ...
  assert.deepEqual(classifyDomain("src/lib/env-placeholders.ts"), {
    domain: "operations-runtime",
    riskTier: "P1",
    reviewBatch: 11,
    classificationRule: "operations-runtime",
  });
  assert.deepEqual(classifyDomain("src/lib/bounded-http-body.ts"), {
    domain: "operations-runtime",
    riskTier: "P1",
    reviewBatch: 11,
    classificationRule: "operations-runtime",
