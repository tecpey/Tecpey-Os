...
for (const path of sourcePaths) {
  ...
  // Literal labels inside request-hash payloads are not audit events. Persisted
  // actions/resources are governed by the typed writer signatures and TypeScript.
  // This guard therefore rejects attempts to erase those types rather than
  // guessing object-literal boundaries with a regex.
  if (
