...
ALERT_SERVICE_TEMPLATE="${REPO_DIR}/deploy/systemd/tecpey-ops-alert-delivery.service.in"
...
render_service "$ALERT_SERVICE_TEMPLATE" "$TMP_DIR/tecpey-ops-alert-delivery.service"
...
printf 'installed=1\n'
printf 'durable_alert_delivery_timer=active\n'
