...
**Source:** `npm run audit:hygiene:json`  
**Schema:** 1  
**Related:** #26
...
Classification: **D — unresolved vendor ownership**. They may be intentional placeholders referenced by a vendor manifest. Do not delete without browser/runtime and manifest verification.
