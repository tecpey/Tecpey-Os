...
| Accepted risks | Every remaining non-blocking risk has a named owner, expiration/review date, mitigation, rollback condition and approval owner. | Accepted-risk register evidence is accepted for NOG-08. Go remains blocked by protected staging, recovery reconciliation, incident readiness and approvals. |
