...
**Current exact main / proposed next candidate:** `5e65ec55e003986187083a71a84272676dc09ccc`

**Proposed candidate source:** `main` after PR #581

**Protected execution during promotion:** allowed only for exact-candidate evidence collection

The accepted candidate `79c48a16cb685a88315a44e103b3758cf7845d65` and its controlled-scope Go evidence remain historical and exact-candidate-bound. They do not authorize the newer runtime. Main advanced through public runtime resilience, Academy login/profile continuity, Iran-safe authentication, secure Limoo/Resend communications operations, the PR #566 pinned OpenSSL runtime remediation, PR #568 secure Limoo Pattern OTP, and the governed product/runtime integration line through PR #581. The proposed candidate is recorded separately in `docs/launch/generated/candidate-promotion-state-20260821.json` and is accepted only for exact-SHA evidence collection after genuine NOG-03/NOG-04/NOG-06 evidence was recollected and atomically promoted.
...
Phase 2 targets the exact post-PR #581 main commit `5e65ec55e003986187083a71a84272676dc09ccc`. The recollection request is `docs/launch/generated/candidate-evidence-recollection-request-20260821.json`. Exact-main workflow, container-image and rollback artifacts are attached only after the governed promotion change verifies and records their immutable URLs, IDs and digests.
...
2. Verify and attach genuine exact-head workflow evidence for `5e65ec55e003986187083a71a84272676dc09ccc` before NOG-04 can be accepted there.
...
7. Accepted NOG-01, NOG-02, NOG-05, NOG-07, NOG-08 and NOG-09 evidence remains valid only for `79c48a16cb685a88315a44e103b3758cf7845d65`; promotion to `5e65ec55e003986187083a71a84272676dc09ccc` must reopen those blockers until fresh exact-candidate evidence is accepted.
...
The PR-head evidence from PR #581 (`e609e45c827d419550f1a1d5346d280a72eced33`) is useful validation of the governed Infinite Growth activation, but it is not exact-candidate evidence for the post-merge `main` commit `5e65ec55e003986187083a71a84272676dc09ccc` and must not be substituted for it.
