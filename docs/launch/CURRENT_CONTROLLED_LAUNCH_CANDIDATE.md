...
**Current candidate SHA:** `c154702f9c927df971dc08787c939357956be97d`  
**Candidate source:** `main` after PR #527 strict UI/UX QA documentation  
**Candidate selected at:** `2026-08-21T20:54:37Z`  
...
PR #527 advanced exact `main` after the post-#525 candidate. The exact release identity now selected is:

```text
c154702f9c927df971dc08787c939357956be97d
```
...
`9bd4ca5ec22e99e2d7deb192826ef8c018ee4913`, `e4065675473170f62f0ed4dec8641f8d77722725` and `1c2172144f5a5fbe3037a262c67cb9799585c1b2` retain their historical evidence only. Their run URLs, digests or artifacts may not be relabelled as evidence for the current SHA.
