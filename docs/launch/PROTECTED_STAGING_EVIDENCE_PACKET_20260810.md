...
**Staging evidence target SHA:** `38c2cd36d0236045bf3c9fbcf093ec431dc47768`
**Runtime candidate baseline:** `38c2cd36d0236045bf3c9fbcf093ec431dc47768`
...
`docs/launch/CURRENT_CONTROLLED_LAUNCH_CANDIDATE.md` after PR #539 repaired `main` and Candidate Evidence Recollection Authority #93 accepted exact-main NOG-03/NOG-04/NOG-06 evidence. Older PR #437/#441, 915c/c154 and e355 recollection SHAs remain historical draft baselines only.
...
| NOG-03 | Immutable runtime image digest is recorded | Accepted for exact candidate `38c2cd36d0236045bf3c9fbcf093ec431dc47768`: `sha256:68c8b5c1ba65980671a9e293bfcc06621c70350521f3b0f5ea829c57a3b0997a`. | docs/launch/generated/runtime-image-digest-evidence-20260812.json | Exact release identity recorded; Go still blocked by remaining evidence |
...
`38c2cd36d0236045bf3c9fbcf093ec431dc47768`, the GitHub API status remains unchanged for this blocker pair:
...
| Field | Evidence |
|---|---|
| Candidate SHA | `38c2cd36d0236045bf3c9fbcf093ec431dc47768` |
| Image | `ghcr.io/tecpey/tecpey-os` |
| Image digest | `sha256:68c8b5c1ba65980671a9e293bfcc06621c70350521f3b0f5ea829c57a3b0997a` |
| Container Supply Chain run | `https://github.com/tecpey/Tecpey-Os/actions/runs/32624736115` |
| Release artifact | `container-release-38c2cd36d0236045bf3c9fbcf093ec431dc47768` |
| Release artifact digest | `sha256:d533d242eb151215d590bbd70968624f504750360a17413ad72e8d565dee713e` |
| Signature verification | Cosign verification records issuer `https://token.actions.githubusercontent.com`, subject `.github/workflows/container-supply-chain.yml@refs/heads/main`, workflow SHA `38c2cd36d0236045bf3c9fbcf093ec431dc47768`, and docker manifest digest matching the image digest above. |
...
|---|---|---|
| CI | `https://github.com/tecpey/Tecpey-Os/actions/runs/32624736126` | success on `38c2cd36d0236045bf3c9fbcf093ec431dc47768` |
| Full Suite Diagnostics | `https://github.com/tecpey/Tecpey-Os/actions/runs/32624736094` | success on `38c2cd36d0236045bf3c9fbcf093ec431dc47768` |
| API Security Manifest | `https://github.com/tecpey/Tecpey-Os/actions/runs/32624736116` | success on `38c2cd36d0236045bf3c9fbcf093ec431dc47768` |
| Sensitive Mutation Audit | `https://github.com/tecpey/Tecpey-Os/actions/runs/32624736120` | success on `38c2cd36d0236045bf3c9fbcf093ec431dc47768` |
| Repository Audit Manifest | `https://github.com/tecpey/Tecpey-Os/actions/runs/32624736104` | success on `38c2cd36d0236045bf3c9fbcf093ec431dc47768` |
| Public Browser Golden Path | `https://github.com/tecpey/Tecpey-Os/actions/runs/32624736107` | success on `38c2cd36d0236045bf3c9fbcf093ec431dc47768` |
| Container Supply Chain | `https://github.com/tecpey/Tecpey-Os/actions/runs/32624736115` | success on `38c2cd36d0236045bf3c9fbcf093ec431dc47768` |
| Full History Secret Scanning | `https://github.com/tecpey/Tecpey-Os/actions/runs/32624736117` | success on `38c2cd36d0236045bf3c9fbcf093ec431dc47768` |
| Scheduled Operational Recovery | `https://github.com/tecpey/Tecpey-Os/actions/runs/32624743010` | success on `38c2cd36d0236045bf3c9fbcf093ec431dc47768` |
...
|---|---|
| Candidate SHA | `38c2cd36d0236045bf3c9fbcf093ec431dc47768` |
| Previous release SHA | `fc67fbab308540962dc3cdcae833a2560bfb4f4b` |
| Container Supply Chain run | `https://github.com/tecpey/Tecpey-Os/actions/runs/32624736115` |
| Rollback job | `Ephemeral staging rollback and volume restore`, job `97158183852`, success |
| Recovery artifact | `container-recovery-38c2cd36d0236045bf3c9fbcf093ec431dc47768` |
| Recovery artifact digest | `sha256:c9d9e3eb69f5059e25b05fbe0723513c081367ca9ec6284c18deeb580448ed55` |
...
| RTO sample | synthetic CI recovery completed in `4770ms` under the `300s` maximum |
