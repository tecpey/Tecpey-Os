...
5. `/api/community/journals` resolves a strict canonical session and verified tenant/workspace/principal context.
...
- the Arena asset;
- the learner's bounded lesson learned;
- controlled mistake tags;
- the bounded next-action commitment;
...
- Invalid page limits or cursors return `400`.
